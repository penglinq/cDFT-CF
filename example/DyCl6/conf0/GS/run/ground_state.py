'''
Calculate the GHF ground state of [DyCl6]-3 in the target basis (sarc-dkh2), 
starting from various density matrix initial guess to the GHF. 
Different initial guesses are indexed by occ_idx (an integer between 0 and 20), 
corresponding to different J vector orientations.
The initial guesses are obtained by projecting the density matrix of the GHF 
ground state in the minimal basis into the target basis, and then modified to 
change the J vector orientation. 
'''
import pyscf
