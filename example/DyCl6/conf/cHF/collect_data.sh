grep "dft energy\*\* " run*/slurm_generate*.out | sed 's/\/slurm.*\]//' > energy.out
grep "energy .*functional PBE0 " run_*/slurm_generate*.out | sed 's/energy .*functional PBE0//' | sed 's/\/slurm.*out://' > energy_PBE0.out
