...
basis_final = basis #{'default': 'cc-pvdz', 'Dy': 'cc-pvdz-x2c'} # select basis 
spin = 5
# End of user input
...
# Shannon, “Revised Effective Ionic Radii and Systematic Studies of Interatomic Distances in Halides and Chalcogenides.” (Ho3+, Y3+)
ele2radius = {'Ho': 1.155, 'Dy': 1.052, 'Y': 1.159, 'C': 0.75, 'Cl': 0.99, 'H': 0.32, 'N': 0.71, 'O': 0.63, 'Cs': 2.02,
              'Na': 1.16} 
